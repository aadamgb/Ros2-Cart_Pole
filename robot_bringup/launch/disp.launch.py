...
def generate_launch_description():
    ...
    # world_path = os.path.join(get_package_share_directory(package_name),'worlds', 'apply_link_wrench.sdf')
    ...
    # urdf_path = os.path.join(get_package_share_directory(package_name),'urdf','box.urdf')
